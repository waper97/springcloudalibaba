 ...
 *
 * @author wangpeng
 * @since 2022-04-26 16:14:17
 */
@Data
@ApiModel(value = "日主生产计划")
public class DayMasterProductionPlaning extends PageDTO implements Serializable {
    private static final long serialVersionUID = 854171300864403873L;
