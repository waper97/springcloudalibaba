 ...
 *
 * @author wangpeng
 * @since 2022-04-26 16:14:19
 */
@Data
@ApiModel(value = "日主生产计划")
public class DayMasterProductionPlaningVO implements Serializable {
    private static final long serialVersionUID = 943722245514491798L;
    ...
    */
     ...
     *矿粉需求计划编号
     */
    @ApiModelProperty(value = "矿粉需求计划编号")
    ...
    @ApiModelProperty(value = "日矿粉需求编号")
    private String dayMineralPowderRequirementsPlanningCode;
