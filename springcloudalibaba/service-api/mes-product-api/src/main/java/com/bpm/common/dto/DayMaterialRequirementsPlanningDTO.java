...
public class DayMaterialRequirementsPlanningDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = 976301622753247338L;
    ...
    * 运算日期
    */    
    @ApiModelProperty(value = "运算开始日期")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
        private LocalDateTime operationDateBegin;


    /**
     * 运算日期
     */
    @ApiModelProperty(value = "运算结束日期")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime operationDateEnd;
    ...
    */    
    ...
    /**
     * 运算开始时间 yyyy-MM-dd hh:mm:ss
     */
    @ApiModelProperty(value = "运算开始时间 yyyy-MM-dd hh:mm:ss")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    ...
    /**
     * 运算结束时间 yyyy-MM-dd hh:mm:ss
     */
    @ApiModelProperty(value = "运算结束时间 yyyy-MM-dd hh:mm:ss")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
