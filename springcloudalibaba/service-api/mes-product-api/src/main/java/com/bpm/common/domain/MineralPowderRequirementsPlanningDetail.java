...
public class MineralPowderRequirementsPlanningDetail implements Serializable {
    private static final long serialVersionUID = 967354927685254175L;
    ...
    */
     ...
     * 计划类型
     */
    @ApiModelProperty(value = "计划类型 正式、预排")
    private String planType;

    @ApiModelProperty(value = "是否 生成过主生产计划 0否，1是")
