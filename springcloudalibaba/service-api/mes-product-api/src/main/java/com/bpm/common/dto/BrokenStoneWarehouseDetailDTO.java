...
/**
 * 碎石仓详情(BrokenStoneWarehouseDetail)传输类
 *
 * @author wangpeng
...
public class BrokenStoneWarehouseDetailDTO extends PageDTO implements Serializable {
    private static final long serialVersionUID = 615332070847456699L;
