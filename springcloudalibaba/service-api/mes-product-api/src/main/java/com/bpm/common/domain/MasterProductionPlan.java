...
public class MasterProductionPlan implements Serializable {
    private static final long serialVersionUID = 271021076952421928L;
    ...
    * 生产车间 外键 生产线id
    */    
    @ApiModelProperty(value = "生产车间 外键 部门")
