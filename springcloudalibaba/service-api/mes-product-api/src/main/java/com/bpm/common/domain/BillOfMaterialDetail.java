...
public class BillOfMaterialDetail implements Serializable {
    ...
    private Integer mesProductBillOfMaterialId;
    ...
    private Integer materialPropertiesId;

    /**
     * bom(物料清单)明细表id  自关联
    */
    @ApiModelProperty(value = "bom(物料清单)明细表id  自关联")
    private Integer mesProductBillOfMaterialDetailId;


    private Integer subitemMaterielId;
    ...
    */
    ...
    private BigDecimal subitemMaterialQuantity;
    ...
    */
    ...
    private BigDecimal materielQuantity;
