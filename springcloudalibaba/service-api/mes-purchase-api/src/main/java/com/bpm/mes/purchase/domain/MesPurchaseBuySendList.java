...
/**
 * 配送计划明细表(MesPurchaseBuySendList)实体类
 *
 * @author renruiling
 * @since 2022-04-28 16:42:36
 */
@Data
@ApiModel(value = "MesPurchaseBuySendList")
public class MesPurchaseBuySendList implements Serializable {
    private static final long serialVersionUID = -76803549049151190L;
    /**
     * 主键id
     */
