...
/**
 * 收货通知单主表(MesPurchaseBuyAccept)实体类
 *
 * @author renruiling
 * @since 2022-04-28 16:42:53
 */
@Data
@ApiModel(value = "MesPurchaseBuyAccept")
public class MesPurchaseBuyAccept implements Serializable {
    private static final long serialVersionUID = 397296863446393179L;
    /**
     * 主键id
     */
