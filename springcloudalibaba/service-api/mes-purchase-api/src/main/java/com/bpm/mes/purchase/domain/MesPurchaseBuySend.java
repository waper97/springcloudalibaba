...
/**
 * 配送计划主表(MesPurchaseBuySend)实体类
 *
 * @author renruiling
 * @since 2022-04-28 16:42:00
 */
@Data
@ApiModel(value = "MesPurchaseBuySend")
public class MesPurchaseBuySend implements Serializable {
    private static final long serialVersionUID = 437463384274691351L;
    /**
     * 主键id
     */
    ...
    private Integer expectedAccepterId;
    /**
     * 预计收货人名称
     */
