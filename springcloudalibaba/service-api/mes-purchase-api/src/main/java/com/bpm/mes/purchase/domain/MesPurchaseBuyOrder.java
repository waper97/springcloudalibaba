...
/**
 * 采购订单主表(MesPurchaseBuyOrder)实体类
 *
 * @author renruiling
 * @since 2022-04-28 16:41:18
 */
@Data
@ApiModel(value = "MesPurchaseBuyOrder")
public class MesPurchaseBuyOrder implements Serializable {
    private static final long serialVersionUID = 166987845685191082L;
    /**
     * 主键id
     */
