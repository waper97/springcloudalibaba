...
@Data
public class MesPurchaseBuyAcceptQueryByIdVO {
    /**
     * 主键id
     */
    ...
    @ApiModelProperty(value = "单据类型：数据字典")
     ...
     * 明细表list
     */
    @ApiModelProperty("明细表list")
    private List<MesPurchaseBuyAcceptListQueryByIdVO> list;
}
