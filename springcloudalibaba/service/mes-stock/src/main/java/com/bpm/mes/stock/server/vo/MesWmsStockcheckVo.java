 ...
 */
@Data
public class MesWmsStockcheckVo {
        /**
         * 主表ID
         */
         ...
         * 仓库id
         */
        @ApiModelProperty(value = "仓库库区库位id")
        private Integer stockPlaceId;
        /**
         * 仓库编码
         */
        @ApiModelProperty(value = "仓库库区库位编码")
        private String stockPlaceCode;
        /**
         * 仓库名称（盘点仓库）
         */
        @ApiModelProperty(value = "仓库库区库位名称（盘点仓库）")
        ...
        @ApiModelProperty(value = "质检明细信息")
        private List<MesWmsStockchecklist> lists;
